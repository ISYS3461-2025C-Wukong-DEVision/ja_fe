  ...
  return (
    <div className="flex min-h-screen w-screen items-center justify-center bg-primary/10 px-4">
      <div className="flex flex-row rounded bg-white m-10 shadow-lg">
        <img src="assets/images/Login.png" alt="bg" className='max-h-[90vh] min-h-[700px] object-cover transition-all duration-300 ease-in-out sm:min-w-[180px] md:min-w-[350px] lg:min-w-[600px] xl:min-w-[700px] min-w-px max-[525px]:opacity-0'/>
